    ...
    routing {
        authenticate("auth-jwt") {
            ...
            route("/timetables/{weekOfYear}") {
                ...
                val getTimetableByStudyGroup: GetTimetableByStudyGroupUseCase by inject()
                ...
                get {
                    ...
                    val timetable = getTimetableByStudyGroup(studyGroupIds, courseIds, memberIds, roomIds, weekOfYear)
                    call.respond(HttpStatusCode.OK, timetable)
                }
            }
        }
